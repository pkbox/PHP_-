    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            <tr>
                ...
                <tr>
                    <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" /><?php echo ($results["ar_id"]); ?></td>
                    ...
                    <td><?php switch($results["type_id"]): case "1": ?>科幻<?php break;?>
                  ...
                  <?php case "9": ?>动画<?php break; endswitch;?></td>
                    <td>
                        <div class="button-group">
                            <a class="button button1 border-main" href="<?php echo U('admin/movie/add/id');?>/<?php echo ($results["ar_id"]); ?>"><span class="icon-edit"></span> 修改</a>
                            <a class="button button2 border-main" href="<?php echo U('admin/movie/detail/id');?>/<?php echo ($results["ar_id"]); ?>"><span class="icon-edit"></span> 详情</a>
...
<script type="text/javascript">
    ...
    function select() {
        $(".button2").click(function(){
            var url="<?php echo U('admin/movie/detail');?>";
            var tr=$(this).parent().parent().parent();
